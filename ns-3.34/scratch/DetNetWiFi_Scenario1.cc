 ...
 ********************************************************************************************/
        ...
        positionAllocAP1->Add (Vector( 75, 0, 0)); //Position of AP1 (at 40,0,0)
        ...
        positionAllocAP2->Add (Vector (35, 0, 0));//Position of AP2 20m from AP1
        ...
        positionAllocstaw1->Add (Vector (0, 0.0, 0.0)); //Position of W1, close to AP2 (served by AP2)
	...
	*/
	...
	//broj burst-ova ne utice toliko na RTT
	ftm_params.SetNumberOfBurstsExponent(50); //2 bursts
	//nema promjene RTT-a
	ftm_params.SetBurstDuration(20); //8 ms burst duration, this needs to be larger due to long processing delay until transmission
		//ovim parametrom nema mijenjanja RTT-a
	ftm_params.SetMinDeltaFtm(10); //1000 us between frames
	ftm_params.SetPartialTsfNoPref(true);
	ftm_params.SetAsap(true);
	//RTT se ne mijenja
	ftm_params.SetFtmsPerBurst(10);
	//ovim isto - RTT se ne mijenja
